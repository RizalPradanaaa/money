...
<div class="row">
    ...
    <div class="card w-100">
        <div class="card-body p-4">
            <div class="row d-flex justify-content-between mb-3">
                <div class="col-6">
                    <h5 class="card-title fw-semibold mb-4">LAPORAN STATUS ANGGARAN PROJECT</h5>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="input-group mb-3">
                <label class="input-group-text" for="periodeAwalSelect">Periode Awal</label>
                <select class="form-select" id="periodeAwalSelect">
                    <option selected></option>
                    <option value="1">Q1-2021</option>
                    <option value="2">Q2-2021</option>
                    <option value="3">Q3-2021</option>
                    <option value="4">Q4-2021</option>
                    <option value="5">Q1-2022</option>
                    <option value="6">Q2-2022</option>
                    <option value="7">Q3-2022</option>
                    <option value="8">Q4-2022</option>
                    <option value="9">Q1-2023</option>
                    <option value="10">Q2-2023</option>
                    <option value="11">Q3-2023</option>
                    <option value="12">Q4-2023</option>
        ...
        <div class="col-3">
            <div class="input-group mb-3">
                <label class="input-group-text" for="periodeAkhirSelect">Periode Akhir</label>
                <select class="form-select" id="periodeAkhirSelect">
                    <option selected></option>
                    <option value="1">Q1-2021</option>
                    <option value="2">Q2-2021</option>
                    <option value="3">Q3-2021</option>
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="input-group">
                <label class="input-group-text" for="groupBySelect">Group By</label>
                <select class="form-select" id="groupBySelect">
                    <option selected></option>
                    <option value="1">Default</option>
                    <option value="2">Modul</option>
                    <option value="3">Intervensi</option>
                    <option value="4">Cost Group</option>
                </select>
            </div>
        </div>
        ...
        <div class="col-3">
            <div class="input-group">
                <label class="input-group-text" for="statusSaldoSelect">Status Saldo</label>
                <select class="form-select" id="statusSaldoSelect">
                    <option selected></option>
                    <option value="1">Tampilkan Nol</option>
                    <option value="2">Tidak Tampilkan Nol</option>
                </select>
            </div>
        </div>
    </div>
