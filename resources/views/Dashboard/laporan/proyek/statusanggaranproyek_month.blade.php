...
<div class="row">
    ...
    <div class="card w-100">
        <div class="card-body p-4">
            <div class="row d-flex justify-content-between mb-3">
                <div class="col-6">
                    <h5 class="card-title fw-semibold mb-4">LAPORAN STATUS ANGGARAN PROJECT BULANAN</h5>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-4 form-check">
            <input type="checkbox" class="form-check-input" id="tampilkanNolCheck">
            <label class="form-check-label" for="tampilkanNolCheck">Tampilkan Nol</label>
        </div>
