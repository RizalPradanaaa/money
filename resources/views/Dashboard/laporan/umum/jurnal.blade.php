...
<div class="row">
    ...
    <div class="card w-100">
        <div class="card-body p-4">
            <div class="row d-flex justify-content-between mb-3">
                <div class="col-6">
                    <h5 class="card-title fw-semibold mb-4">LAPORAN JURNAL UMUM</h5>
                </div>
    ...
    <div class="col-3">
        <div class="input-group mb-3">
            <label class="input-group-text" for="tipeSelect">Tipe</label>
...
<div class="row">
    ...
    <div class="col-3">
        <div class="input-group">
            <label class="input-group-text" for="referenceNoInput">Nomer Referensi</label>
            <input type="text" class="form-control form-control-sm" id="referenceNoInput">
        </div>
    </div>
              ...
              <tbody>
                <tr>
                  <td class="border-bottom-0">
                    <h6 class="fw-semibold mb-0 fs-4">25 Oktober 2023</h6>
                  </td>
                  <td class="border-bottom-0">
                  ...
                  <td class="border-bottom-0">
                    <h6 class="fw-semibold mb-0 fs-4">025</h6>
                  </td>
                  <td class="border-bottom-0">
